    ...
    <div className="home-page">
      <div className="home-hero">
        ...
        <h1 className="home-title">
          Certificates that<br /><em>cannot be faked.</em>
        </h1>
        <p className="home-sub">
          Issue tamper-proof credentials stored permanently on a decentralised
          network. Anyone can verify authenticity instantly — with just a link.
        </p>
      ...
      <div className="home-stats">
        <div className="stat-item">
          ...
          <span className="stat-label">Cryptographic integrity proof</span>
        </div>
        <div className="stat-item">
          <span className="stat-value">∞</span>
          <span className="stat-label">Permanent decentralised storage</span>
        </div>
        <div className="stat-item">
          <span className="stat-value">&lt;1s</span>
          <span className="stat-label">Instant public verification</span>
        </div>
        <div className="stat-item">
          <span className="stat-value">0</span>
          <span className="stat-label">Trust required to verify</span>
        </div>
      </div>
      ...
      <div className="home-trust">
        <p className="section-heading">Why it works</p>
        <div className="trust-grid">
          <div className="trust-card">
            <div className="trust-icon">⛓</div>
            <h4>Blockchain anchored</h4>
            <p>Every certificate's hash is written to the Aptos blockchain — a public, immutable timestamp no party can dispute.</p>
          </div>
          <div className="trust-card">
            <div className="trust-icon">🔐</div>
            <h4>Mathematically verifiable</h4>
            <p>SHA-256 hashing means any tampering changes the fingerprint. Forgery is detectable instantly, forever.</p>
          </div>
          <div className="trust-card">
            <div className="trust-icon">🌐</div>
            <h4>Decentralised storage</h4>
            <p>No single server to take down. Shelby's distributed network ensures certificates outlast any institution.</p>
          </div>
        </div>
      </div>
    </div>
